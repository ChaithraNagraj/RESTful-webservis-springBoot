 ...
 * @RequestParameter:is used to define the custom or dynamic request uri
 * @author chaithra
 *
 */
@RestController
public class ProductServiceController {
	private static Map<String, Product> productRepo = new HashMap<>();
	   ...
	   /****
	    * @GET:this not requeire any request body
	    * @POST:request is used to create a resource
	    * @DELETE:is used to delete existing resource
	    * @PUT:is used to update the existing resources
	    * @param id
	    * @return
	    */
